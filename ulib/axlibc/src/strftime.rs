    ...
    pub unsafe fn inner_strftime<W: WriteByte>(
        ...
        while *format != 0 {
            ...
            match *format as u8 {
                ...
                // b's' => w!("{}", super::ax_mktime(t as *mut crate::libctypes::tm)),
                b's' => w!("{}", super::mktime(t as *mut crate::libctypes::tm)),
                b'S' => w!("{:02}", (*t).tm_sec),
                b'T' => w!(recurse "%H:%M:%S"),
...
pub unsafe extern "C" fn strftime(
    ...
    size: ctypes::size_t,
    format: *const c_char,
    timeptr: *const crate::libctypes::tm,
) -> ctypes::size_t {
