...
#	cp $(APP)/redis_fpconv_makefile $(APP)/redis/deps/fpconv/Makefile
	...
	cd $(APP)/redis && CC=aarch64-linux-musl-gcc USE_JEMALLOC=no $(MAKE) -j V=1 REDIS_CFLAGS='-Werror -Wno-unused-parameter -Wno-int-conversion -Wno-restrict -Wno-format -Wno-unused-variable -Wno-maybe-uninitialized -nostdinc -fno-builtin -I/home/yanjuguang/OS/arceos/ulib/c_libax/include' REDIS_LDFLAGS+='-nostdlib -static -T/home/yanjuguang/OS/arceos/modules/axhal/linker_aarch64.lds' CFLAGS="-static -no-pie -mno-outline-atomics" LDFLAGS="-static -no-pie"
